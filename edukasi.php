      ...
      <div class="col">
        <div class="row mt-5">
          <h2 class="text-center  wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">Paket Wisata
            Edukasi</h2>
          <p class="text-center wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s"> Wisata edukasi ditujukan
            kepada pelajar hingga masyarakat umum dimana mereka dapat belajar dengan cara yang lebih menyenangkan.
          </p>
        </div>
        <div class="row">
            ...
            <div id="carouselExampleInterval" class="carousel slide wow fadeInLeft" data-wow-duration="1s"
              ...
              <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="3000">
                  <img src="assets/wisata/batik1.jpeg" class="d-block w-150" />
                </div>
                <div class="carousel-item" data-bs-interval="3000">
                  <img src="assets/wisata/domba2.jpg" class="d-block w-150" />
                </div>
                <div class="carousel-item" data-bs-interval="3000">
                  <img src="assets/wisata/kopi2.jpeg" class="d-block w-150" />
                </div>
                <div class="carousel-item" data-bs-interval="3000">
                  <img src="assets/wisata/akar4.jpg" class="d-block w-150" />
                </div>
                <div class="carousel-item" data-bs-interval="3000">
                  ...
                  <div class="row">
                    <div class="col-md-10">
                      <button class="btn btn-block text-left collapsed" type="button" data-toggle="collapse"
                        ...
                        <strong>Paket 55k/pax</strong> <i class="fa-solid fa-chevron-down accordion__chevron"></i>
                      </button>
                    </div>
                    <div class="col-md-2">
                  ...
                  <div class="row">
                    <div class="col-md-10">
                      <button class="btn btn-block text-left collapsed" type="button" data-toggle="collapse"
                        ...
                        <strong>Paket 95k/pax </strong><i class="fa-solid fa-chevron-down accordion__chevron"></i>
                      </button>
                    </div>
                    <div class="col-md-2">
