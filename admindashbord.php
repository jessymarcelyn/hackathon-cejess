	...
	<div class = "container">
		...
		<div class = "row">
			...
			<div class = "col-2" style="margin-left: -3.2rem; margin-top:4rem">
				...
				<button class = "btn btn-dark" id = "transaction" style="margin-top: 20px; padding-left: 2rem; padding-right: 2rem;">Transactions</button><br>
				<button class = "btn btn-dark" id = "dt" style="margin-top: 20px; ; padding-left: 1.2rem; padding-right: 1.2rem">Detail Transaksi</button><br>
				<button class = "btn btn-dark" id = "user"style="margin-top: 20px; padding-left: 3.5rem; padding-right: 3.5rem">User</button><br>
				<button class = "btn btn-dark" id = "quiz" style="margin-top: 20px; padding-left: 3.5rem; padding-right: 3.5rem" >Quiz</button><br>
				<button class = "btn btn-dark" id ="wisata" style="margin-top: 20px; padding-left: 3rem; padding-right: 3rem">Wisata</button><br>
