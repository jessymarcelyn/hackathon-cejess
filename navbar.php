...
<!-- NAVBAR START -->
<header class="header-area header-sticky wow slideInDown bg-light sticky-top" data-wow-duration="0.75s"
  data-wow-delay="0s">
  <div class="container">
    <div class="row">
      <div class="col-12">
        <nav class="main-nav">
          ...
          <ul class="nav">
            ...
            <li>
              <div class="dropdown">
                <a href="#wisata" class="dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                  Wisata
                </a>
