      ...
      <div class="col">
        <div class="row mt-5">
          ...
          <p class="text-center wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s"> Wisata edukasi yang
            ditujukan untuk anak-anak (TK/PAUD-SD) yang dimana mereka dapat berpariwisata sambil belajar
          </p>
        </div>
        <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-10">
                      <button class="btn btn-block text-left collapsed" type="button" data-toggle="collapse"
                        ...
                        <strong>Paket 45k/pax</strong> <i class="fa-solid fa-chevron-down accordion__chevron"></i>
                      </button>
                    </div>
                    <div class="col-md-2">
            ...
            <div class="card">
                  ...
                  <div class="row">
                    <div class="col-md-10">
                      <button class="btn btn-block text-left collapsed" type="button" data-toggle="collapse"
                        ...
                        <strong>Paket 65k/pax </strong><i class="fa-solid fa-chevron-down accordion__chevron"></i>
                      </button>
                    </div>
                    <div class="col-md-2">
                      <button class="btn beli align-self-center">Beli sekarang</button>
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                <div class="card-body">
                  <ul>
                    <li>📌Cafe Gumitir</li>
                    <li>📌Terowongan Mrawan</li>
                    <li>📌Stasiun Mrawan</li>
                    <li>📌PPG Wisata Pinus</li>
                  </ul>
                </div>
              </div>
